...
if __name__ == "__main__":
    ...
    # sub_names = ['S' + str(i+1) for i in range(0, 6)] # GPU 3640
    # sub_names = ['S' + str(i+1) for i in range(6, 12)]
    # sub_names = ['S' + str(i+1) for i in range(12, 18)]

    sub_names = ['S' + str(i+1) for i in range(9, 18)]
    ...
    # dataset = "No_vanilla" #  No_vanilla 是 64hz
    seed = 200
