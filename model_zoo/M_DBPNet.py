...
class M_DBPNet(nn.Module):
    def __init__(self, in_channels, window_length):
        ...
        self.tem = Temporal_Branch(in_channels, window_length)
        self.linear = nn.Linear(8, 2)
...
if __name__ == '__main__':
    ...
    # 初始化模型
    model = M_DBPNet(args.csp_dim, args.tem_tokens).to(device)
    ...
    print("Model size: {:.2f}M".format(param_m))  # 保留两位小数的浮点数格式
