function [ Sr ] = lwcov( X )
% LWCOV computes a well-conditioned (regularized) covariance matrix
...
% 
% INPUT
% X = a data matrix (observations x variables)
% 
% OUTPUT
% Sr = regularized covariance matrix (variables x variables)
% 
...
Sr = b2/d2 * m * eye(nvar) + a2/d2 * S; % cfr. eq. (14) in [1]
